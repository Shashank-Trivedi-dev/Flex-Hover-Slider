## Welcome to  [ # Flex Hover Slider | HTML + CSS + jQuery ]  HTML Code Sections

## Code Link
- Github:       [ Shashank Trivedi Dev ]---------( https://github.com/Shashank-Trivedi-dev/Flex-Hover-Slider )
- Codepen:      [ @Shashank-Trivedi-Dev ]--------( https://codepen.io/Shashank-Trivedi-Dev/pen/jOXmOQg )
- Replit:       [ @Shashank-Trivedi-Dev ]--------( https://replit.com/@Shashank-Trivedi-Dev/Flex-Hover-Slider )
- Website Blog: [ ShashankTrivedi.com ]----------( https://shashanktrivedi.com/section/flex-hover-slider-html-css-jquery/ )
